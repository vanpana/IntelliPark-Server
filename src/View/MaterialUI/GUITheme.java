...
public class GUITheme {
  ...
  private static final Font ITALIC = getFont ("src/View/MaterialUI/Roboto-Italic.ttf");
  private static final Font LIGHT = getFont ("src/View/MaterialUI/Roboto-Light.ttf");
  private static final Font BOLD = getFont ("src/View/MaterialUI/Roboto-Medium.ttf");
  private static final Font REGULAR = getFont ("src/View/MaterialUI/Roboto-Regular.ttf");
  private static final Font THIN = getFont ("src/View/MaterialUI/Roboto-Thin.ttf");
  private static final Font THIN_ITALIC = getFont ("src/View/MaterialUI/RobotoCondensed-LightItalic.ttf");
  ...
  private static Font getFont (String fileName) {
    try {
      return Font.createFont (Font.TRUETYPE_FONT, new FileInputStream (new File (fileName))).deriveFont (14f);
    }
    catch (IOException e) {
