...
import com.cyberschnitzel.smartspark.DashboardUI;
import com.cyberschnitzel.smartspark.component.ProfilePreferencesWindow;
import com.cyberschnitzel.smartspark.domain.Transaction;
import com.cyberschnitzel.smartspark.domain.User;
import com.cyberschnitzel.smartspark.event.DashboardEvent.NotificationsCountUpdatedEvent;
import com.cyberschnitzel.smartspark.event.DashboardEvent.PostViewChangeEvent;
import com.cyberschnitzel.smartspark.event.DashboardEvent.ProfileUpdatedEvent;
import com.cyberschnitzel.smartspark.event.DashboardEvent.ReportsCountUpdatedEvent;
import com.cyberschnitzel.smartspark.event.DashboardEvent.TransactionReportEvent;
import com.cyberschnitzel.smartspark.event.DashboardEvent.UserLoggedOutEvent;
...
public final class DashboardMenu extends CustomComponent {
    ...
    private Component buildTitle() {
        Label logo = new Label("SmartSpark <strong>Dashboard</strong>",
                ContentMode.HTML);
    ...
    private Component buildUserMenu() {
        ...
        final Employee emp = getCurrentUser();
        ...
        settingsItem.addItem("Edit Profile", new Command() {
            ...
            public void menuSelected(final MenuItem selectedItem) {
                ProfilePreferencesWindow.open(emp, false);
            }
        });
        settingsItem.addItem("Preferences", new Command() {
            @Override
            public void menuSelected(final MenuItem selectedItem) {
                ProfilePreferencesWindow.open(emp, true);
            }
        });
    ...
    public void updateUserName(final ProfileUpdatedEvent event) {
        ...
        settingsItem.setText(emp.getName() + " " + emp.getSurname());
    }
