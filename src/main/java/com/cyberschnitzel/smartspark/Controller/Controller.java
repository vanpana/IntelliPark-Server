package com.cyberschnitzel.smartspark.Controller;
...
import com.cyberschnitzel.smartspark.domain.Entities.Vacation;
...
public class Controller {
    ...
    public boolean checkLogin(String email, String password){
        ...
        return e != null && getEmployee(email).getPassword().equals(password);
    }
